...
public class BookModiAndDelIFrame extends JInternalFrame {
	...
	private Object[][] getFileStates(List list){
		...
		for(int i=0;i<list.size();i++){
			...
			results[i][1]=bookinfo.getTypeid();
...
//		panel_1.add(button_2);
	...
	class addBookActionListener implements ActionListener {
		public void actionPerformed(final ActionEvent e) {
			...
			int i=Dao.Updatebook(ISBNs, bookTypes, bookNames, writers, translators, publishers, Date.valueOf(pubDates), prices);
